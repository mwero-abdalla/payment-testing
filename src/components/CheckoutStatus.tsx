...
import { AlertCircle, CheckCircle2, ShoppingCart, XCircle } from "lucide-react";
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 space-y-1">
          ...
          <div className="text-sm opacity-90">
            {isSuccessful ? (
              <p>
                Your order #{orderId?.slice(-8) || "..."} has been updated. You
                can view the details in your dashboard.
              </p>
            ) : isCancelled ? (
              <p>
                The checkout process was cancelled. Your items are still in your
                cart.
              </p>
            ) : isPending ? (
              <p>
                We're waiting for confirmation from your provider. This usually
                takes a few seconds.
              </p>
            ) : (
