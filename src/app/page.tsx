...
export default function Home() {
  return (
    <div className="relative isolate">
      ...
      >
        <div
          className="relative left-[calc(50%-11rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#38bdf8] to-[#fbbf24] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style={{
            clipPath:
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600 dark:text-slate-300">
            A specialized workspace for end-to-end validation of Paystack and
            Pesapal integrations. Initialize transactions, verify callbacks, and
            monitor database state in one place.
          </p>
        ...
        <div className="mx-auto mt-24 max-w-7xl">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Link
              href="/paystack"
              className="group relative flex flex-col items-start rounded-[2rem] border border-white/10 bg-white p-8 shadow-xl transition-all duration-300 hover:-translate-y-2 dark:bg-slate-900/50 dark:hover:bg-slate-900"
            >
              ...
              <p className="mt-4 text-slate-600 dark:text-slate-400">
                Test initialization, authorization redirects, and transaction
                verification using Paystack's API.
              </p>
            ...
            >
              ...
              <p className="mt-4 text-slate-600 dark:text-slate-400">
                Validate IFrame redirects, IPN registration, and synchronous
                callback processing for Pesapal V3.
              </p>
            ...
            >
              ...
              <p className="mt-4 text-slate-600 dark:text-slate-400">
                Monitor MongoDB records for orders and payments in real-time.
        ...
        <div className="mt-32 grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3">
          <div className="flex gap-x-6">
            ...
            <div>
              <h4 className="text-base font-semibold leading-7 text-slate-900 dark:text-white">
                End-to-End Validation
              </h4>
              <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-400">
                Every state change is tracked from initialization to final
                confirmation.
              </p>
            </div>
          </div>
          <div className="flex gap-x-6">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-400">
                Instant visibility into webhook and IPN processing results.
              </p>
            </div>
          </div>
          <div className="flex gap-x-6">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-400">
                Access provider response payloads directly from the database.
              </p>
            </div>
          </div>
        </div>
